 <?php $__env->startSection('site_title', 'Blog Details Page'); ?> <?php $__env->startSection('content'); ?>
    ...
    <div class="container px-8 mx-auto xl:px-5 max-w-screen-lg py-5 lg:py-8">
        ...
        <div class="comment_data">
            <h4 class="text-2xl mt-8 mb-4">Comments -
                <?php echo e(count($blog['comment']) < 10 && count($blog['comment']) != 0 ? '0' . count($blog['comment']) : count($blog['comment'])); ?>

            </h4>
            <hr class="my-4" />
            <?php $__empty_1 = true; $__currentLoopData = $blog['comment']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex items-start mb-4">
                    <div class="flex">
                        <span
                            class="flex justify-center items-center w-[40px] h-[40px] bg-indigo-600 text-white font-bold rounded-[50%] mr-5 uppercase"><?php echo e(substr($comment['name'], 0, 1)); ?></span>
                        <div>
                            <h5 class="font-bold"><?php echo e($comment->email); ?></h5>
        ...
        <form class="mt-8" id="comment_form">
            ...
            <input type="hidden" id="blog_id" value="<?php echo e($blog->id); ?>" />
            <div class="mb-4">
    ...
    try {
        ...
        form.addEventListener("submit", async (e) => {
            ...
            if (name.length === 0) {
                ...
                const URL = "<?php echo e(url('/comment')); ?>";
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Hamza\OneDrive\Desktop\php-problem-solving-master\assignment\resources\views/blog_details.blade.php ENDPATH**/ ?>