    ...
    <script>
        (async () => {
            try {
                ...
                const URL = "<?php echo e(url('/allBlog')); ?>";
                ...
                respone.data.forEach(blog => {
                    ...
                    let link = "<?php echo e(route('blog.details', ':id')); ?>".replace(':id', blog['id']);
                    document.getElementById('blogs').innerHTML += `<div class="p-4 md:w-1/3">
                    <div class="h-full bg-red-200 border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Hamza\OneDrive\Desktop\php-problem-solving-master\assignment-19\resources\views/index.blade.php ENDPATH**/ ?>